...
-- tras a quantidade de produtos de cada comanda
SELECT 
	P.DESCRICAO,
(SELECT  
...
SELECT 
	P.DESCRICAO,CA.CATEGORIA, P.OBSERVACOES,P.PRECO, COUNT(*) AS CONT
FROM 
...
WHERE 
	P.COD_PRODUTO = IC.COD_PRODUTO 
		...
		AND
			IC.COD_COMANDA = '1000'
GROUP BY 
	P.DESCRICAO, P.PRECO, CA.CATEGORIA,P.OBSERVACOES 
